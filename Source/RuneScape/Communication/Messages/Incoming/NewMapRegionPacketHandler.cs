...
{
    /// <summary>
    /// Handler for new map region packet.
    /// </summary>
    public class NewMapRegionPacketHandler : IPacketHandler
    {
        #region Methods
        /// <summary>
        /// Handles the new map region signal sent after map data is sent to the client.
        /// </summary>
