...
{
    /// <summary>
    /// Handler for adding ignores.
    /// </summary>
    public class AddIgnorePacketHandler : IPacketHandler
    {
        #region Methods
        /// <summary>
        /// Handles added ignores by the character.
        /// </summary>
        ...
        {
            character.Contacts.AddIgnore(packet.ReadLong());
        }
        #endregion Methods
    }
}
