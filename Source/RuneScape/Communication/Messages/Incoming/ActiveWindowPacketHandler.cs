...
{
    /// <summary>
    /// Handler for checking client window activity.
    /// </summary>
    public class ActiveWindowPacketHandler : IPacketHandler
    {
        #region Methods
        /// <summary>
        /// Handles client window activity.
        /// </summary>
        ...
        public void Handle(Character character, Packet packet)
        {
            ...
            character.Preferences.ActiveWindow = (b == 1 ? true : false);
        }
        #endregion Methods
    }
}
