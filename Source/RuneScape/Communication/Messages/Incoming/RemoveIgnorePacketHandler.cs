...
{
    /// <summary>
    /// Handler for removing ignores.
    /// </summary>
    public class RemoveIgnorePacketHandler : IPacketHandler
    {
        #region Methods
        /// <summary>
        /// Handles removed ignores by the character.
        /// </summary>
        ...
        {
            character.Contacts.RemoveIgnore(packet.ReadLong());
        }
        #endregion Methods
    }
}
