...
{
    /// <summary>
    /// Handler for quiet packets.
    /// </summary>
    public class QuietPacketHandler : IPacketHandler
    {
        #region Methods
        /// <summary>
        /// Handles the quiet packets sent to the server which don't nessesarily need to be handled.
        /// </summary>
