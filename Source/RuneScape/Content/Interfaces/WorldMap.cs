...
{
    /// <summary>
    /// Represents the world map interface shown when clicked the globe beside mini map.
    /// </summary>
    public class WorldMap : IInterfaceHandler
    {
        #region Fields
        /// <summary>
        /// The id of this interface.
        /// </summary>
        public const int InterfaceId = 755;
        #endregion Fields
