...
{
    /// <summary>
    /// A coordinate event that accepts atrade request.
    /// </summary>
    public class AcceptTradeEvent : CoordinateEvent
    {
        #region Fields
        /// <summary>
        ...
        public AcceptTradeEvent(Character character, Character other)
        ...
        public override void Execute()
        {
            ...
            {
                this.Character.Request.AnswerTrade(other);
            }
        }
        #endregion Methods
    }
